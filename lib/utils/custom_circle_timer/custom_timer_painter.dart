...
class CustomTimerPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (backgroundColor != null || backgroundGradient != null) {
      ...
      backgroundPaint.color = AppColors.white;
      canvas.drawCircle(
          size.center(Offset.zero), 90, backgroundPaint);
      backgroundPaint.color = AppColors.lightpinkColor;
      canvas.drawCircle(
          size.center(Offset.zero), 80, backgroundPaint);
      backgroundPaint.color = AppColors.pinkColor;
      canvas.drawCircle(
          size.center(Offset.zero), 70, backgroundPaint);
    }
  }
