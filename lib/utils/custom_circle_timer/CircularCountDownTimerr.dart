...
class CircularCountDownTimerr extends StatefulWidget {
  ...
  final CountDownControllerr? controller;
  ...
  */
  ...
  @override
  CircularCountDownTimerrState createState() => CircularCountDownTimerrState();
}

class CircularCountDownTimerrState extends State<CircularCountDownTimerr>
    with TickerProviderStateMixin {
  AnimationController? _controller;
  Animation<double>? _countDownAnimation;
  CountDownControllerr? countDownController;
  ...
  @override
  void initState() {
    countDownController = widget.controller ?? CountDownControllerr();
    super.initState();
...
/// Controls (i.e Start, Pause, Resume, Restart) the Countdown Timer.
class CountDownControllerr {
  CircularCountDownTimerrState? _state;
  bool? _isReverse;
