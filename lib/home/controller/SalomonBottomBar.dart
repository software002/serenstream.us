            ...
            for (final item in items)
              TweenAnimationBuilder<double>(
                ...
                builder: (context, t, _) {
                 ...
                 final _selectedTextColor  =item.selectedTextColor ?? Colors.white;
                  return Material(
                    color: items.indexOf(item) == currentIndex
                        ?_selectedColor:_unselectedColor/*Color.lerp(
                    ...
                    child: InkWell(
                      ...
                      focusColor: items.indexOf(item) == currentIndex
                          ?_selectedColor:_unselectedColor/*_selectedColor.withOpacity(0.1)*/,
                      highlightColor:items.indexOf(item) == currentIndex
                          ?_selectedColor:_unselectedColor/* _selectedColor.withOpacity(0.1)*/,
                      splashColor:items.indexOf(item) == currentIndex
                          ?_selectedColor:_unselectedColor /*_selectedColor.withOpacity(0.1)*/,
                      hoverColor:items.indexOf(item) == currentIndex
                          ?_selectedColor:_unselectedColor /*_selectedColor.withOpacity(0.1)*/,
                      child: Padding(
                        padding: itemPadding -
                              ...
                              child: SizedBox(
                                ...
                                child: Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Visibility(
                                      visible: items.indexOf(item) == currentIndex,
                                      child: DefaultTextStyle(
                                        style: TextStyle(
                                          color:_selectedTextColor /*Color.lerp(
                                              _selectedColor.withOpacity(0.0),
                                              _selectedColor,
                                              t)*/,
