...
class BreatheOutScreen extends StatefulWidget {
  final Duration timer_value;
  BreatheOutScreen({super.key, required this.timer_value});

  @override
  State<BreatheOutScreen> createState() => _BreatheOutScreenState();
}

class _BreatheOutScreenState extends State<BreatheOutScreen>
            ...
            children: [
              ...
              Center(
                  child: commonWidget.countDownTimer(
                      context, _controller, (widget.timer_value ~/ 3).inSeconds,"breatheout",widget.timer_value)),
              SizedBox(
                height: 35.h,
              ),
              Center(child: commonWidget.title_breath("Breathe Out")),
